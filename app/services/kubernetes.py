...
def create_container(
    ...
    # 1. Ensure user config exists with defaults
    ...
    config_service.save_user_config(user_id=user_id, config_name=config_name, config=user_config, overwrite=False)
